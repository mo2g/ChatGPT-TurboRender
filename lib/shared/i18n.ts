...
const MESSAGE_CATALOG = {
  en: {
    ...
    labelHistoryInspection: 'History view',
    ...
    statusPopupTopShelfHint: 'Managed history is available from the history shelf at the top of the conversation.',
  ...
  'zh-CN': {
    ...
    statusPopupTopShelfHint: '被处理历史可在对话顶部的历史条中查看。',
